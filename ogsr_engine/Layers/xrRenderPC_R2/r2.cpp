...
void CRender::create()
{
    ...
    */
    ...
    o.no_ram_textures = strstr(Core.Params, "-noramtex") ? TRUE : FALSE; // ps_r__common_flags.test( RFLAG_NO_RAM_TEXTURES );
...
void CRender::reset_end()
{
    ...
    for (u32 i=0; i<HW.Caps.iGPUNum; ++i)
        R_CHK
    (HW.pDevice->CreateQuery(D3DQUERYTYPE_EVENT,&q_sync_point[i]));
    */
...
{
    return Models->Create(name, data, canBePrefetched);
}
