...
void dxEnvironmentRender::RenderSky(CEnvironment& env)
{
    ...
    u32 C = color_rgba_f(env.CurrentEnv->sky_color.x, env.CurrentEnv->sky_color.y, env.CurrentEnv->sky_color.z, env.CurrentEnv->weight);
...
void dxEnvironmentRender::RenderClouds(CEnvironment& env)
{
    ...
    u32 C1 = color_rgba_f(env.CurrentEnv->clouds_color.x, env.CurrentEnv->clouds_color.y, env.CurrentEnv->clouds_color.z, env.CurrentEnv->clouds_color.w);
