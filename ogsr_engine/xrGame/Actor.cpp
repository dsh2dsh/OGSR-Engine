...
bool CActor::PlayHitSound(SHit* pHDS)
{
    ...
    case ALife::eHitTypeRadiation: return false; break;
    default: return (!fsimilar(sndHitMin[pHDS->hit_type], pHDS->damage()) && pHDS->damage() > sndHitMin[pHDS->hit_type]);
    }
}
...
#pragma todo("Dima to Dima : forward-back bone impulse direction has been determined incorrectly!")
        ...
        callback(GameObject::eHit)(lua_game_object(), perc, vLocalDir, smart_cast<const CGameObject*>(who)->lua_game_object(), element, pHDS);
    }
}
...
bool CActor::hasUpdated() { return m_updated; }
