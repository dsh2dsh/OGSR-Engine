...
void CAI_Stalker::Die(CObject* who)
{
    ...
    m_hammer_is_clutched =
        m_clutched_hammer_enabled && !m_headshot && !CObjectHandler::planner().m_storage.property(ObjectHandlerSpace::eWorldPropertyStrapped) && !::Random.randI(0, 2);
...
CMovementManager* CAI_Stalker::create_movement_manager() { return (m_movement_manager = xr_new<stalker_movement_manager_obstacles /*CStalkerMovementManager*/>(this)); }
