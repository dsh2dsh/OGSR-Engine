...
// DEBUG purpose only
char* dbg_action_name_table[] = {"ACT_STAND_IDLE", "ACT_SIT_IDLE", "ACT_LIE_IDLE", "ACT_WALK_FWD", "ACT_WALK_BKWD", "ACT_RUN",         "ACT_EAT",
...
void CControlAnimationBase::check_hit(MotionID motion, float time_perc)
{
    ...
    if (should_hit && pA)
    {
        ...
        collide::ray_defs RD(C, dir, params.dist, CDB::OPT_FULL_TEST, collide::rqtBoth);
