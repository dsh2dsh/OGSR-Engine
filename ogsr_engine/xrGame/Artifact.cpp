...
void CArtefact::PlayAnimIdle(u8 state)
{
    switch (state)
    {
    case eSubstateIdleMoving: m_pHUD->animPlay(random_anim(m_anim_idle_moving), TRUE, this, GetState()); break;
    case eSubstateIdleSprint: m_pHUD->animPlay(random_anim(m_anim_idle_sprint), TRUE, this, GetState()); break;
    default: m_pHUD->animPlay(random_anim(m_anim_idle), TRUE, this, GetState());
    }
}
