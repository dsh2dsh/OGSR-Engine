...
//////////////////////////////////////////////////////////////////////////
	...
	DetailPathManager::EDetailPathType	detail_path_type	() const;
			...
			const CCoverPoint	*far_cover( const Fvector&, const Fvector&, float, float, float, float );
			const CCoverPoint	*far_cover( const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>& );
			const CCoverPoint	*close_cover( const Fvector&, const Fvector&, float, float, float, float );
			const CCoverPoint	*close_cover( const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>& );
