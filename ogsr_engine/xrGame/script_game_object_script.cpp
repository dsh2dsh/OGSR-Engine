           ...
           class_<enum_exporter<GameObject::ECallbackType>>("callback")
               .enum_("callback_types")
                   [value("trade_start", int(GameObject::eTradeStart)), value("trade_stop", int(GameObject::eTradeStop)),
                    ...
                    value("on_actor_weapon_start_firing", int(GameObject::eOnActorWeaponStartFiring)), value("on_actor_weapon_fire", int(GameObject::eOnActorWeaponFire)),
                    value("on_actor_weapon_reload", int(GameObject::eOnActorWeaponReload)), value("on_actor_weapon_jammed", int(GameObject::eOnActorWeaponJammed)),
                    ...
                    value("on_actor_weapon_zoom_out", int(GameObject::eOnActorWeaponZoomOut)), value("on_actor_weapon_switch_gl", int(GameObject::eOnActorWeaponSwitchGL)),

                    // NPC Callbacks.
                    value("on_npc_weapon_start_firing", int(GameObject::eOnNPCWeaponStartFiring)), value("on_npc_weapon_fire", int(GameObject::eOnNPCWeaponFire)),
                    value("on_npc_weapon_jammed", int(GameObject::eOnNPCWeaponJammed)), value("on_npc_weapon_reload", int(GameObject::eOnNPCWeaponReload)),
                    value("on_npc_weapon_empty", int(GameObject::eOnNPCWeaponEmpty)), value("on_npc_weapon_switch_gl", int(GameObject::eOnNPCWeaponSwitchGL)),
                    // Cribbledirge End
                    ...
                    value("on_level_map_click", int(GameObject::eUIMapClick)), value("on_map_spot_click", int(GameObject::eUIMapSpotClick)),
                    value("on_pickup_item_showing", int(GameObject::eUIPickUpItemShowing)), value("on_group_items", int(GameObject::eUIGroupItems)),
                    value("on_weapon_shell_drop", int(GameObject::eOnWpnShellDrop)), value("on_throw_grenade", int(GameObject::eOnThrowGrenade)),
                    value("on_goodwill_change", int(GameObject::eOnGoodwillChange)), value("update_artefacts_on_belt", int(GameObject::eUpdateArtefactsOnBelt)),
