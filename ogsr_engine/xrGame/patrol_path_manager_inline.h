...
IC void CPatrolPathManager::set_path(shared_str path_name) { set_path(ai().patrol_paths().safe_path(path_name, false, true, true), path_name); }
...
{
    set_path(ai().patrol_paths().safe_path(path_name, false, true, true), path_name);
