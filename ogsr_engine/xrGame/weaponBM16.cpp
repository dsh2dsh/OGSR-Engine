...
void CWeaponBM16::Load(LPCSTR section)
{
    ...
    animGetEx(mhud_shot2, pSettings->line_exist(hud_sect.c_str(), "anim_shoot_2") ? "anim_shoot_2" : "anim_shoot");
    ...
    animGetEx(mhud_idle_sprint_1,
              pSettings->line_exist(hud_sect.c_str(), "anim_idle_sprint_1")   ? "anim_idle_sprint_1" :
                  pSettings->line_exist(hud_sect.c_str(), "anim_idle_sprint") ? "anim_idle_sprint" :
                                                                                "anim_idle_1");
    animGetEx(mhud_idle_sprint_2,
              pSettings->line_exist(hud_sect.c_str(), "anim_idle_sprint_2")   ? "anim_idle_sprint_2" :
                  pSettings->line_exist(hud_sect.c_str(), "anim_idle_sprint") ? "anim_idle_sprint" :
                                                                                "anim_idle_2");
    animGetEx(mhud_idle_moving_1,
              pSettings->line_exist(hud_sect.c_str(), "anim_idle_moving_1")   ? "anim_idle_moving_1" :
                  pSettings->line_exist(hud_sect.c_str(), "anim_idle_moving") ? "anim_idle_moving" :
                                                                                "anim_idle_1");
    animGetEx(mhud_idle_moving_2,
              pSettings->line_exist(hud_sect.c_str(), "anim_idle_moving_2")   ? "anim_idle_moving_2" :
                  pSettings->line_exist(hud_sect.c_str(), "anim_idle_moving") ? "anim_idle_moving" :
                                                                                "anim_idle_2");

    animGetEx(mhud_show1, pSettings->line_exist(hud_sect.c_str(), "anim_draw_1") ? "anim_draw_1" : "anim_draw");
    animGetEx(mhud_show2, pSettings->line_exist(hud_sect.c_str(), "anim_draw_2") ? "anim_draw_2" : "anim_draw");
    animGetEx(mhud_hide1, pSettings->line_exist(hud_sect.c_str(), "anim_holster_1") ? "anim_holster_1" : "anim_holster");
    animGetEx(mhud_hide2, pSettings->line_exist(hud_sect.c_str(), "anim_holster_2") ? "anim_holster_2" : "anim_holster");
