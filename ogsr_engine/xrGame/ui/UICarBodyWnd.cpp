...
void CUICarBodyWnd::Init()
{
    ...
    if (pSettings->section_exist("engine_callbacks") && pSettings->line_exist("engine_callbacks", "init_car_body"))
    {
...
void CUICarBodyWnd::callScriptInitCarBody()
{
    ...
    {
        auto GO = m_pOthersObject ? smart_cast<CGameObject*>(m_pOthersObject) : smart_cast<CGameObject*>(m_pInventoryBox);
