...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject>&& instance)
{
    return std::move(instance)
        ...
        .def("far_cover",
             (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>&))(&CScriptGameObject::far_cover))
        ...
        .def(
            "close_cover",
            (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>&))(&CScriptGameObject::close_cover))
