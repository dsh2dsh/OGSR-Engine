...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject>&& instance)
{
	return std::move(instance)
		...
		.def( "far_cover",  ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, float, float ) ) ( &CScriptGameObject::far_cover ) )
		.def( "far_cover",  ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>& ) ) ( &CScriptGameObject::far_cover ) )
		.def( "close_cover",  ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, float, float ) ) ( &CScriptGameObject::close_cover ) )
		.def( "close_cover",  ( const CCoverPoint* ( CScriptGameObject::* ) ( const Fvector&, const Fvector&, float, float, float, float, const luabind::functor<bool>& ) ) ( &CScriptGameObject::close_cover ) )
...
//		.def("set_sight",					(void (CScriptGameObject::*)(const MemorySpace::CMemoryInfo *memory_object, bool	torso_look))(&CScriptGameObject::set_sight))
		...
		.def( "mark_item_hidden",      &CScriptGameObject::markItemHidden )
		.def( "mark_item_visible",     &CScriptGameObject::markItemVisible )
		.def( "clear_marked_hidden",   &CScriptGameObject::clearMarkedHidden )
		.def( "clear_marked_visible",  &CScriptGameObject::clearMarkedVisible )
	;
}
