...
ALife::_SPAWN_ID CALifeSimulator__spawn_id(CALifeSimulator* self, LPCSTR obj_name) { return ((const CALifeSimulator*)self)->spawns().spawn_id_by_name(obj_name); }
...
void CALifeSimulator::script_register(lua_State* L)
{
    module(L)[class_<CALifeSimulator>("alife_simulator")
                  ...
                  .def("spawn_id", (ALife::_SPAWN_ID(*)(CALifeSimulator*, ALife::_SPAWN_STORY_ID))(CALifeSimulator__spawn_id))
                  .def("spawn_id", (ALife::_SPAWN_ID(*)(CALifeSimulator*, LPCSTR))(CALifeSimulator__spawn_id))
                  .def("actor", &get_actor)
