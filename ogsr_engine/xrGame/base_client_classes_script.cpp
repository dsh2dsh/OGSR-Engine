...
void CObjectScript::script_register(lua_State* L)
{
    module(L)[class_<CGameObject, bases<DLL_Pure, ISheduled, ICollidable, IRenderable>, CGameObjectWrapper>("CGameObject")
              ...
              class_<CGlobalFlags>("global_flags") // для оптимальности доступа, предполагается в скриптах скопировать элементы этого "класса" в пространство имен _G
                  ...
                  .enum_("weapon_states")[value("eIdle", int(CWeapon::EWeaponStates::eIdle)), value("eFire", int(CWeapon::EWeaponStates::eFire)),
                                          value("eFire2", int(CWeapon::EWeaponStates::eFire2)), value("eReload", int(CWeapon::EWeaponStates::eReload)),
                                          value("eShowing", int(CWeapon::EWeaponStates::eShowing)), value("eHiding", int(CWeapon::EWeaponStates::eHiding)),
                                          value("eHidden", int(CWeapon::EWeaponStates::eHidden)), value("eMisfire", int(CWeapon::EWeaponStates::eMisfire)),
                                          value("eMagEmpty", int(CWeapon::EWeaponStates::eMagEmpty)), value("eSwitch", int(CWeapon::EWeaponStates::eSwitch))]
...
void CCameraScript::script_register(lua_State* L)
{
    module(L)[class_<CCameraBase>("CCameraBase")
              ...
              class_<enum_exporter<CCameraBase>>("CCameraBaseFlags")
                  .enum_("CCameraBaseFlags")[value("flRelativeLink", int(CCameraBase::flRelativeLink)), value("flPositionRigid", int(CCameraBase::flPositionRigid)),
...
void CPatrolPathScript::script_register(lua_State* L)
{
    module(L)[class_<CPatrolPath>("CPatrolPath")
                  ...
                  .def("add_edge",
                       (void(CPatrolPath::*)(const u32&, const u32&,
                                             const float&))(
                           &CPatrolPath::add_edge))
