...
CSoundPlayer::CSoundCollection* CSoundPlayer::add_deferred( LPCSTR prefix, u32 max_count, ESoundTypes type, u32 priority, u32 mask, u32 internal_type, LPCSTR bone_name, CSound_UserDataPtr data )
{
  SOUND_COLLECTIONS::iterator I = m_sounds.find( internal_type );
  if ( I != m_sounds.end() )
    return nullptr;
