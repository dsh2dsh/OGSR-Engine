                    ...
                    DEF_ACTION("turn_engine", kENGINE)
                        ...
                        DEF_ACTION("cam_1", kCAM_1) DEF_ACTION("cam_2", kCAM_2) DEF_ACTION("cam_3", kCAM_3) DEF_ACTION("cam_4", kCAM_4) DEF_ACTION("cam_zoom_in", kCAM_ZOOM_IN)
                            DEF_ACTION("cam_zoom_out", kCAM_ZOOM_OUT)
                                ...
                                DEF_ACTION("torch", kTORCH) DEF_ACTION("night_vision", kNIGHT_VISION) DEF_ACTION("wpn_1", kWPN_1) DEF_ACTION("wpn_2", kWPN_2) DEF_ACTION(
                                    "wpn_3", kWPN_3) DEF_ACTION("wpn_4", kWPN_4) DEF_ACTION("wpn_5", kWPN_5) DEF_ACTION("wpn_6", kWPN_6) DEF_ACTION("wpn_8", kWPN_8)
                                    DEF_ACTION("switch_scope", kSWITCH_SCOPE) DEF_ACTION("wpn_next", kWPN_NEXT) DEF_ACTION("wpn_fire", kWPN_FIRE) DEF_ACTION("wpn_zoom", kWPN_ZOOM)
                                        DEF_ACTION("wpn_zoom_inc", kWPN_ZOOM_INC) DEF_ACTION("wpn_zoom_dec", kWPN_ZOOM_DEC) DEF_ACTION("wpn_reload", kWPN_RELOAD) DEF_ACTION(
                                            ...
                                            DEF_ACTION("pause", kPAUSE) DEF_ACTION("drop", kDROP) DEF_ACTION("use", kUSE) DEF_ACTION("scores", kSCORES) DEF_ACTION("chat", kCHAT)
                                                DEF_ACTION("chat_team", kCHAT_TEAM) DEF_ACTION("screenshot", kSCREENSHOT) DEF_ACTION("quit", kQUIT) DEF_ACTION("console", kCONSOLE)
                                                    DEF_ACTION("inventory", kINVENTORY) DEF_ACTION("buy_menu", kBUY) DEF_ACTION("skin_menu", kSKIN) DEF_ACTION("team_menu", kTEAM)
                                                        DEF_ACTION("active_jobs", kACTIVE_JOBS) DEF_ACTION("map", kMAP) DEF_ACTION("contacts", kCONTACTS)
                                                                ...
                                                                DEF_ACTION("vote_begin", kVOTE_BEGIN) DEF_ACTION("vote", kVOTE) DEF_ACTION("vote_yes", kVOTEYES)
                                                                    DEF_ACTION("vote_no", kVOTENO)
                                                                        ...
                                                                        DEF_ACTION("next_slot", kNEXT_SLOT) DEF_ACTION("prev_slot", kPREV_SLOT)
                                                                            ...
                                                                            DEF_ACTION("speech_menu_0", kSPEECH_MENU_0) DEF_ACTION("speech_menu_1", kSPEECH_MENU_1)
                                                                                DEF_ACTION("speech_menu_2", kSPEECH_MENU_2) DEF_ACTION("speech_menu_3", kSPEECH_MENU_3)
