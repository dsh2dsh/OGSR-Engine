...
CHudItem::~CHudItem(void) { xr_delete(m_pHUD); }
...
void CHudItem::StartHudInertion() { m_bInertionEnable = true; }
void CHudItem::StopHudInertion() { m_bInertionEnable = false; }
...
void CHudItem::OnH_B_Chield() { OnHiddenItem(); }
