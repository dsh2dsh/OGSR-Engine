...
public:
	...
	virtual void HitSignal( float P, Fvector &local_dir, CObject* who, s16 element, SHit* pHDS )
	{
		luabind::call_member<void>( this, "HitSignal", P, local_dir, who, element, pHDS );
	}
