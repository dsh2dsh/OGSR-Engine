...
public:
    ...
    virtual void HitSignal(float P, Fvector& local_dir, CObject* who, s16 element, SHit* pHDS) { luabind::call_member<void>(this, "HitSignal", P, local_dir, who, element, pHDS); }

    static void HitSignal_static(CEntity* self, float P, Fvector& local_dir, CObject* who, s16 element, SHit* pHDS)
    {
