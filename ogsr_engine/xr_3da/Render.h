...
public:
    ...
    // = 0; virtual IRenderVisual*			model_Create			(LPCSTR
    // name, IReader*	data=0) = 0;
    virtual IRenderVisual* model_Create(LPCSTR name, IReader* data = 0,
                                        bool canBePrefetched = false) = 0;
    ...
    // virtual void					model_Delete			(IRenderVisual* &	V, BOOL
    // bDiscard=FALSE) = 0;
    virtual void model_Delete(IRenderVisual*& V, BOOL bDiscard = FALSE) = 0;
    //	virtual void 					model_Delete			(IRender_DetailModel* &
    //F) = 0;
